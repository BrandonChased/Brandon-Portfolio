    ...
    return (
        <div className='container' id="projects">
            ...
            <div style={{flexWrap: "wrap", backgroundColor: "inherit", border: "none"}} className='card pb-5 my-5 d-flex flex-row justify-content-around align-items-end'>
                <Project link={"https://github.com/HJohnRoss/taskApp"} title={"Task Flow"} img={"https://i.imgur.com/dYcnws9.png"} description={"Dating Application, built using Javascript, React, Bcrypt, React-Hooks, Mongoose, MongoDb, and Bootstrap"}/>
